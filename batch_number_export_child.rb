...
def makefile(pathname)
  desktopPointer = File.expand_path("~/Documents/VS3 Num Exports Child/#{pathname}.csv")
       ...
       number_word.cells.each do | thisnumber_wordCell |
          num_fun.cells.each do | thisnum_fun_cateCell |
            ...
            #     if this is true, then collect data and write it to the file
              if thisnumber_wordCell.is_within(thisc_speechCell) && thisnum_fun_cateCell.is_within(thisc_speechCell)
