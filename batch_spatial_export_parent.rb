...
def makefile(pathname)
    desktopPointer = File.expand_path("~/Documents/920_VS1 exports/920_VS1S_p.csv")
    ...
    # childes = getColumn('CHILDES_HEADER')
        ...
        p_speech.cells.each do | thisp_speechCell |
            spa_cate.cells.each do | thisspacate_Cell |
                ...
                if thisspacate_Cell.is_within(thisp_speechCell) && thisspacate_Cell.is_within(thisp_speechCell)
                        ...
                        thisspacate_Cell.patternscomparison,
                    ]
