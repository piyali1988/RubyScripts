...
def makefile(pathname)
  desktopPointer = File.expand_path("~/Documents/VS1 Missing Num Exports/#{pathname}.csv")
...
input_folder = 'Y:\\New Reorganization\\Research\\TMW\\TMW Longitudinal\\CHILDES material\\Transcription\\Completed Transcripts\\Completed Transcripts for Coding\\Session 1\\To be exported' # '~' is shortcut for home directory; ~/Desktop will usually get your desktop folder
